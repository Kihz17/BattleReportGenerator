...
public class ReflectionUtil {
    ...
    public static Object exec(Object obj, Class<?> type, String methodName, Object... args) {
        ...
        try {
            ...
            e.printStackTrace();
            System.out.println("Failed to execute reflected method " + methodName + "!");
        }
        return null;
    }
    ...
    public static <T> T construct(Class<T> clazz) {
        ...
        try {
            ...
            System.out.println("Could not construct '" + clazz.getSimpleName() + "', does it have a no-args constructor?");
    ...
    public static <T> T constructWithArgs(Class<T> clazz, Object... args) {
        ...
        try {
            ...
            System.out.println("Could not construct '" + clazz.getSimpleName() + "'. (" + args.length + " Arguments)");
            throw new RuntimeException(e);
        }
    }
    ...
    public static <T> T forceConstruct(Class<T> clazz) {
        try {
            ...
            if (minParams == Integer.MAX_VALUE) {
                System.out.println("Failed to force-construct '" + clazz.getSimpleName() + "'. No constructor found.");
                return null;
            }
            ...
            ex.printStackTrace();
            System.out.println("Failed to force-construct " + clazz.getSimpleName() + "!");
            return null;
        }
    }
    ...
    public static void setField(Object o, Class<?> from, String varName, Object val) {
        try {
            ...
            e.printStackTrace();
            System.out.println("Failed to set field '" + varName + "'.");
        }
    }
    ...
    private static Field findField(Class<?> clazz, String fieldName) {
        ...
        Utils.verifyNotNull(field, "Unknown field '" + fieldName + "' in " + clazz.getSimpleName() + ".");
        return field;
    }
    ...
    public static Field findFieldIncludeParents(Class<?> clazz, String fieldName) {
        ...
        throw new RuntimeException("Unknown field '" + fieldName + "' in " + clazz.getSimpleName() + " (or its parents).");
    }
    ...
    public static void getFieldMethodHandle(Object o, String fieldName) {
        try {
            ...
            e.printStackTrace();
            System.out.println("Failed to GET field using method handles for field '" + fieldName + "' in " + o.getClass().getSimpleName() + ".");
        }
    }
    ...
    public static void setFieldMethodHandle(Object o, String fieldName, Object newValue) {
        try {
            ...
            e.printStackTrace();
            System.out.println("Failed to set field using method handles for field '" + fieldName + "' in " + o.getClass().getSimpleName() + ".");
        }
    }
    ...
    private static MethodHandle getGetterHandle(Class<?> clazz, String name) {
        try {
            ...
            e.printStackTrace();
            System.out.println("Failed to get getter method lookup for field '" + name + "' in class " + clazz.getSimpleName() + ".");
            return null;
        }
    }
    ...
    private static MethodHandle getSetterHandle(Class<?> clazz, String name) {
        try {
            ...
            e.printStackTrace();
            System.out.println("Failed to get setter method lookup for field '" + name + "' in class " + clazz.getSimpleName() + ".");
            return null;
        }
    }
