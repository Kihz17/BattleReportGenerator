...
/**
 * Store and load array data into JSON.
 * Since there is no java object for an array we must pass our super class a null value and use java's method to get the array's base type.
