...
/**
 * A list that is able to be serialized and deserialized to JSON.
...
public class JsonList<T> implements Jsonable, Iterable<T> {
    ...
    public JsonElement save() {
        ...
        for (T value : getValues()) {
            ...
            if (!Utils.isJsonNull(savedValue)) // Don't check if default value, because lists need to save default values.
